...
#ifdef ENHANCED
#define ENHANCEMENT_NAME "NULL Enhanced Version"
/** EXTRA_PTR_DECLARATION is glommed into the struct extra_data declaration. 
    the extra_data struct is a node of a linked list that holds individual person level data that is not part of the basic vanilla socism

you probably don't want use this.
