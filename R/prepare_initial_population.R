#' Create an initial population for a simulation
#'
#' @description Generate a simple initial population data frame together with
#' an empty marriage file, then write both files to the requested folder.
#'
